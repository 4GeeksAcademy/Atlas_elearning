...
export const UserProfile = () => {
    ...
    // Buscar el usuario en el array de usuarios usando el email
    const currentUser = store.user.access_to_user.find(user=>user.email == userToLogin.email);
    
    // Si no encontramos un usuario con ese email, devolvemos un mensaje de error
    if (!currentUser) {
        return <p>No user data available</p>;
    }

    // Renderizamos la información del usuario encontrado
    return (
