    ...
    return (
        <div className={className}>
            ...
            {details.status === 'COMPLETED' && (
                <div className="bg-white border rounded-4 d-flex justiy-content-center align-items-center">
                    <p className="letter my-2">Date: {details.date}</p>
                    ...
                    <button className="btnFav my-2">Go to Dashboard</button>
                </div>
            )}
        </div>
    );
