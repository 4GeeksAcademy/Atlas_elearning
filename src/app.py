...
# Configuración de Flask-Mail, clave baim wnof kfkr uuaj
app = Flask(__name__)
...
app.config['MAIL_USERNAME'] = os.getenv('alecisnero018@gmail.com')
app.config['MAIL_PASSWORD'] = os.getenv('baim wnof kfkr uuaj')
